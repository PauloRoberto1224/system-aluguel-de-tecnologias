"""
Django settings for sistema_aluguel project.
...
SECRET_KEY = 'django-insecure-ef=3dsq#zy!71h4c=!u5_u-5i874k@f37(-h#o)!56#rmhy$)b'
...
WSGI_APPLICATION = 'sistema_aluguel.wsgi.application'
